...
family={'Michael Douglas':'Kirk Douglas',
        'Kirk Douglas':'Herszel Danielovitch',
          'Maciej Stuhr':'Jerzy Stuhr',
        'Jerzy Stuhr':'Leopold Stuhr',
          'Angelina Jolie':'Jon Voight',
        'Jon Voight':'Elmer Voight',
          'Charlie Sheen':'Martin Sheen',
        'Martin Sheen':'Francisco Estevez Martinez',
...
while choice!='7':
    print("*************************************")
    print("*  Kto jest Twoim tatą i dziadkiem  *")
    print("*************************************\n")

    print("1 - wyświetl cały słownik")
    print("2 - znajdź ojca")
    print("3 - znajdź dziadka")
    print("4 - dodaj parę syn-ojciec")
    print("5 - zmień ojca")
    print("6 - usuń parę")
    print("7 - zakończ\n")
    ...
    if choice=='1':
        ...
        father=input("Wpisz Imię Nazwisko: ")
        if father in family:
            grandfather=family[father]
            if grandfather in family:
                print("\nDziadek: ")
